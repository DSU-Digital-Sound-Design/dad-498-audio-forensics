...
**What to submit**: One Word document (`.docx`) with each question copied in followed by your answer, organized by exercise number, submitted to the D2L assignment.
...
## Before You Begin: Listen to the Recording (~5 minutes)

Before reading the paper or answering any questions, listen to this recording. You will return to it throughout the lab.

Maher's analysis draws on two categories of recordings: the professional lectern microphone and over a dozen user-generated bystander videos. The bystander recordings are no longer reliably available online, so we will focus on the lectern microphone — the primary source for his distance calculations and waveform figures.

**The lectern microphone (C-SPAN broadcast)**
This is the professional audio captured by the podium microphone at the rally. Listen for the moment the shots begin. Try to identify two distinct sounds per shot before you read about the crack-pop sequence.

> Watch Video: [Shots Fired at Trump Rally — C-SPAN clip](https://www.c-span.org/clip/campaign-2024/shots-fired-at-trump-rally/5123735).   
> Download audio here: [Trump Rally Audio](https://d2l.sdbor.edu/content/enforced/202010/2139314-202610DAD-492-D01-27356/trump_rally_audio.wav)
